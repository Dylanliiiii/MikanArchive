...
- 新增非主页专用 `ContentGridLayout`，保留导航、分类条、页脚、浮动控件和文章宽屏目录，同时移除通用横幅与双侧栏。
...
- 收藏三页移除顶部通用分类条，避免“主页 / 归档 / 分类 / 更多”入口干扰收藏内容浏览。
- 摘录收藏改为整张卡片可点击跳转原文，分类标签、分组标题和标签视觉向工具导航统一，并新增暖色卡片底色、轻边框和 hover 彩色阴影反馈。

- 首页继续使用原 Firefly 横幅与双侧栏；文库、收藏、友邻、足迹、我的、文章详情和辅助页面统一改用聚焦内容布局。
