...
- 确定第一版导航为 `主页 / 文库 / 收藏 / 联系我 / 足迹 / 我的`。

### Changed

- 友邻一级入口改为“联系我”，友链内容移动到联系我页面中的友链区域，并新增留言与 QQ 群入口卡片。
- 分类、标签、RSS、足迹、关于、搜索、友链和留言等主要非主页可见大标题统一为工具导航同款英文眉标、图标、主标题和说明节奏。
- 全站移除导航下方通用分类快捷栏，避免“主页 / 归档 / 分类 / 更多”在其他页面重复出现。
- 收藏总览、工具导航与摘录收藏统一为白色 / 半透明 section 打底；收藏总览与摘录收藏的标题、英文眉标、图标和描述节奏对齐工具导航。
- 早期仅收藏三页移除顶部通用分类条；当前已扩展为全站移除导航下方通用分类快捷栏。
- 摘录收藏改为整张卡片可点击跳转原文，分类标签、分组标题和标签视觉向工具导航统一，并新增暖色卡片底色、轻边框和 hover 彩色阴影反馈。

- 首页继续使用原 Firefly 横幅与双侧栏；文库、收藏、联系我、足迹、我的、文章详情和辅助页面统一改用聚焦内容布局。
- 收藏总览与摘录收藏移除旧大块标题卡，改为与工具导航一致的 section 标题系统并直接衔接内容。
